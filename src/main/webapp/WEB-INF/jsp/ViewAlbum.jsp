...
<c:forEach items ="${album}" var="album"> <!-- //name of class -->
  <div class="bio col-3">
    <a href="viewSelectedPostAlbum?postid=${album.id}"> <img
					id="${album.id}" src="${album.image}" style="border-radius: 40%; width: 250px" alt="Profile Page Image" <%-- onclick="openPost(${posts.id})" --%>/>
				</a>
   </div>
    </c:forEach>
